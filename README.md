...
```
# Google Analytics
ga_track_id: 'UA-112759826-1'            # 你用Google账号去注册一个就会给你一个这样的id
ga_domain: shan-shan.family			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
1. 这个模板是从这里 [BY](https://github.com/qiubaiying/qiubaiying.github.io) clone 的, 感谢这个作者。 
